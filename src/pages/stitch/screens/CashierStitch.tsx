...
/**
 * CashierStitch - Caixa e Fechamento
 * Fonte técnica: design-stitch/caixa_e_fechamento_comanda_pro/code.html
 */
export default function CashierStitch() {
  useEffect(() => {
  ...
  return (
    <div className="stitch-scope-cashier bg-background text-on-background font-body-md text-body-md h-screen w-full flex overflow-hidden antialiased">
      <style>{`
        .stitch-scope-cashier {
          --on-error: #ffffff;
          --on-secondary: #ffffff;
        ...
        .stitch-scope-cashier .material-symbols-outlined {
        ...
        .stitch-scope-cashier .font-h1 { font-family: 'Plus Jakarta Sans'; font-weight: 800; font-size: 32px; line-height: 1.2; }
        .stitch-scope-cashier .font-h2 { font-family: 'Plus Jakarta Sans'; font-weight: 700; font-size: 24px; line-height: 1.3; }
        .stitch-scope-cashier .font-h3 { font-family: 'Plus Jakarta Sans'; font-weight: 700; font-size: 20px; line-height: 1.3; }
        .stitch-scope-cashier .font-body-md { font-family: 'Inter'; font-weight: 400; font-size: 16px; line-height: 1.5; }
        .stitch-scope-cashier .font-body-sm { font-family: 'Inter'; font-weight: 400; font-size: 14px; line-height: 1.4; }
        .stitch-scope-cashier .font-label-bold { font-family: 'Inter'; font-weight: 600; font-size: 14px; line-height: 1.0; }
        .stitch-scope-cashier .font-price-display { font-family: 'Plus Jakarta Sans'; font-weight: 700; font-size: 20px; line-height: 1.0; }

        .stitch-scope-cashier .bg-background { background-color: var(--background); }
        .stitch-scope-cashier .bg-surface { background-color: var(--surface); }
        .stitch-scope-cashier .bg-surface-container-low { background-color: var(--surface-container-low); }
        .stitch-scope-cashier .bg-surface-container-lowest { background-color: var(--surface-container-lowest); }
        .stitch-scope-cashier .bg-surface-container-high { background-color: var(--surface-container-high); }
        .stitch-scope-cashier .bg-surface-container { background-color: var(--surface-container); }
        .stitch-scope-cashier .bg-primary { background-color: var(--primary); }
        .stitch-scope-cashier .bg-primary-fixed { background-color: var(--primary-fixed); }
        
        .stitch-scope-cashier .text-on-background { color: var(--on-background); }
        .stitch-scope-cashier .text-on-surface { color: var(--on-surface); }
        .stitch-scope-cashier .text-on-primary { color: var(--on-primary); }
        .stitch-scope-cashier .text-on-primary-fixed { color: var(--on-primary-fixed); }
        .stitch-scope-cashier .text-on-primary-fixed-variant { color: var(--on-primary-fixed-variant); }
        .stitch-scope-cashier .text-primary { color: var(--primary); }
        .stitch-scope-cashier .text-secondary { color: var(--secondary); }
        
        .stitch-scope-cashier .border-outline-variant { border-color: var(--outline-variant); }
        .stitch-scope-cashier .border-primary { border-color: var(--primary); }
        .stitch-scope-cashier .border-surface-variant { border-color: var(--surface-variant); }

        .stitch-scope-cashier .hide-scrollbar::-webkit-scrollbar { display: none; }
        .stitch-scope-cashier .hide-scrollbar { -ms-overflow-style: none; scrollbar-width: none; }
      `}</style>
      ...
      <nav className="bg-white dark:bg-zinc-950 h-full w-72 border-r rounded-none border-r border-zinc-100 dark:border-zinc-800 flex flex-col h-screen p-4 space-y-2 shrink-0 z-10 relative">
        <div className="mb-8 flex items-center gap-3 px-2">
          <div className="w-10 h-10 rounded-full bg-surface-container overflow-hidden shrink-0 border border-outline-variant">
            <img alt="Admin Avatar" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCy4FfzjATJ0TTw4FZGqNajiND7lwkRNyZVI0WxbApLX_RQS0AwISexFjDgBzNkNDo4rY9yuypLxq9pQVYSasQbNjzk_Z_WN1ihXJeXAPlcJvJLKVumAfOau3vb9oBjOo63IGxxzGLPgZQWXgo2sSwhlzKjXCuLuaFRkpkbJbIMi9E7L1VupMmfeNbvtmjR5sLuS0FHLeomEcHDQjgjeUm3EWE_28jCIucB1L1spldTMnNKvjfC2msbK_1QkqD7qSzJtJhNs13jmFo" />
          </div>
          <div>
      ...
      <main className="flex-1 flex flex-col bg-surface min-w-0">
        <header className="bg-white/95 dark:bg-zinc-900/95 backdrop-blur-md full-width top-0 sticky z-50 border-b border-zinc-100 dark:border-zinc-800 shadow-[0_4px_20px_rgba(0,0,0,0.05)] flex items-center justify-between px-4 py-3 w-full h-16 shrink-0">
          ...
          <div className="flex items-center gap-2">
            <div className="relative hidden md:flex items-center">
              ...
              <input className="pl-10 pr-4 py-2 bg-surface-container-low border border-outline-variant rounded-full font-body-sm text-body-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary w-64 transition-all" placeholder="Buscar mesa ou comanda..." type="text" />
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3 hide-scrollbar">
              ...
              <button className="w-full text-left bg-surface-container-lowest border border-outline-variant rounded-lg p-3 flex justify-between items-stretch hover:border-secondary hover:shadow-sm active:scale-[0.98] transition-all group">
                <div className="flex flex-col justify-between">
                  ...
                  <div className="font-label-bold text-label-bold text-secondary mt-2 flex items-center gap-1">
                    Consumindo
                  </div>
                </div>
                <div className="flex flex-col justify-between items-end">
            ...
            <div className="p-5 bg-surface-container-low border-t border-outline-variant rounded-b-xl shrink-0">
              <div className="space-y-2 mb-4">
                ...
                <div className="flex justify-between font-body-md text-body-md text-secondary text-primary">
                  <span className="flex items-center gap-1 cursor-pointer hover:underline"><span className="material-symbols-outlined text-[16px]">add_circle</span> Adicionar Desconto</span>
                  <span>R$ 0,00</span>
                </div>
              </div>
            ...
            <div className="p-5 flex-1 overflow-y-auto hide-scrollbar space-y-6">
              ...
              <div className="bg-surface-container-low p-4 rounded-xl border border-outline-variant">
                ...
                <div className="relative">
                  ...
                  <input className="w-full pl-12 pr-4 py-3 bg-white border border-outline-variant rounded-lg font-h2 text-h2 text-right focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all" type="text" defaultValue="284,35" />
                </div>
