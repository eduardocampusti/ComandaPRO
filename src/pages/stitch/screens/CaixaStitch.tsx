...
/**
 * CaixaStitch - Caixa e Fechamento
  ...
  return (
    <div className="stitch-scope-caixa bg-background text-on-background font-body-md text-body-md h-screen w-full flex overflow-hidden antialiased">
      <style>{`
        ...
        .stitch-scope-caixa .bg-background { background-color: var(--background); }
        .stitch-scope-caixa .bg-surface { background-color: var(--surface); }
        .stitch-scope-caixa .bg-surface-container-low { background-color: var(--surface-container-low); }
        .stitch-scope-caixa .bg-surface-container-lowest { background-color: var(--surface-container-lowest); }
        .stitch-scope-caixa .bg-surface-container-high { background-color: var(--surface-container-high); }
        .stitch-scope-caixa .bg-surface-container { background-color: var(--surface-container); }
        .stitch-scope-caixa .bg-primary { background-color: var(--primary); }
        .stitch-scope-caixa .bg-primary-fixed { background-color: var(--primary-fixed); }
        
        .stitch-scope-caixa .text-on-background { color: var(--on-background); }
        .stitch-scope-caixa .text-on-surface { color: var(--on-surface); }
        .stitch-scope-caixa .text-on-primary { color: var(--on-primary); }
        .stitch-scope-caixa .text-on-primary-fixed { color: var(--on-primary-fixed); }
        .stitch-scope-caixa .text-on-primary-fixed-variant { color: var(--on-primary-fixed-variant); }
        .stitch-scope-caixa .text-primary { color: var(--primary); }
        .stitch-scope-caixa .text-secondary { color: var(--secondary); }
        
        .stitch-scope-caixa .border-outline-variant { border-color: var(--outline-variant); }
        .stitch-scope-caixa .border-primary { border-color: var(--primary); }
        .stitch-scope-caixa .border-surface-variant { border-color: var(--surface-variant); }
